---
name: pm-retrospective-review
description: |
  生成结构化的上线复盘报告，包含目标达成、偏差原因、经验沉淀和后续行动项。当用户说写复盘、上线复盘、迭代总结时触发此 Skill。 关键词：复盘、上线复盘、项目复盘、迭代复盘、版本回顾、版本总结、复盘学习。
---
...
1. **要复盘什么项目或迭代？**
2. **复盘的目的是什么？**（总结经验、改进流程、团队成长）

如果背景信息不完整，我会输出一份「复盘框架问卷」，帮助你系统性地回顾项目。
